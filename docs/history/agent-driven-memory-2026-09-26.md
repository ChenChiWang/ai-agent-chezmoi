...
> Archived 2026-09-26: this note accompanied public commit `eb5ba06` (an earlier snapshot of the same work). The current contract is [sync-v2.md](../sync-v2.md) and the [architecture adjustment plan](../architecture-adjustment-plan.md).
